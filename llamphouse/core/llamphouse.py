...
class LLAMPHouse:
    def __init__(self, assistants: List[Assistant] = [], worker_type = "thread", api_key: Optional[str] = None, thread_count: int = 1):
...
"""
    ...
    def ignite(self, host="0.0.0.0", port=80, reload=False):
        ...
        async def startup_event():
            ...
            worker = WorkerFactory.create_worker(self.worker_type, self.assistants, self.fastapi.state, self.thread_count, loop)
            worker.start()
